...
plot(nei1, vertex.size = ver_size, vertex.label = NA, vertex.color = ver_col)
...
plot(nei1, edge.width = 0.5, vertex.size = ver_size, vertex.label = NA, vertex.frame.color = NA, vertex.color = ver_col)
...
plot(nei2, vertex.size = ver_size, vertex.label = NA, vertex.color = ver_col)
...
plot(nei2, edge.width = 0.5, vertex.size = ver_size, vertex.label = NA, vertex.frame.color = NA, vertex.color = ver_col)
